...
declare module 'awful' {
  ...
  import { PatternRef, SurfaceRef, ShapeRef, AlignX, FontRef } from 'gears';

  export namespace widget {
    type TasklistArgs<T extends Layout> = {
      layout: T;
      spacing: RealNumber;
      buttons: AwfulButton<Client>[];
      source: (this: void, screen: Screen, args: TasklistArgs<T>) => Client[];
