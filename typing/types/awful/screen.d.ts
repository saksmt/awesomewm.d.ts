...
declare module 'awful' {
  import { Table, Geometry, Margins, Direction } from 'gears';
  ...
  export type Screen = {
    ...
    connect_signal: {
      (name: Screen.Signal.Added, cb: (this: void) => void): void;
      (name: Screen.Signal.Removed, cb: (this: void) => void): void;
      (name: Screen.Signal.List, cb: (this: void) => void): void;
      (name: Screen.Signal.PrimaryChanged, cb: (this: void) => void): void;
      (
        name: Screen.Signal.Swapped,
        cb: (this: void, other: Screen, isSource: boolean) => void,
      ): void;
      (name: string, cb: UntypedFunction): void;
    };
    disconnect_signal(name: Screen.Signal | string, cb: UntypedFunction): void;
  } & Table;
