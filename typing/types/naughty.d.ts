...
declare module 'naughty' {
  import { Timer, Table, ShapeRef, PatternRef, SurfaceRef, AlignOnMargins } from 'gears';
  import { ScreenRef } from 'awful';
  import { widget, container } from 'wibox';
  ...
  export let notify: (this: void, args: NotificationProps) => Notification | undefined;
